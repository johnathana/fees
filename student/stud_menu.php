...
<body id="overview"> 
	...
	<div class="content promos grid2col"> 
		<div id="container">
			...
			<table align="center">
				<tr><td><input style="width:180px; height:40px;" class="button" type="button" name="application" value="Που μπορώ να προσφέρω έργο" /></td></tr>
				<tr><td><input style="width:180px; height:35px;" class="button" type="button" name="overview" value="Οι παροχές μου" /></td></tr>
			</table>
		</div>
	</div><!--/content--> 
